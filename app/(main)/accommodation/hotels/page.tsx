...
async function fetchHotels() {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL}/api/accommodations?type=hotel`, { cache: 'no-store' })
  if (!res.ok) return [];
  return res.json();
}
    ...
    <div className="min-h-screen pt-16 lg:pt-20 bg-gray-50 overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="mb-12 sm:mb-16">
          <AccommodationCarousel images={images} showRating={true} />
        </div>
