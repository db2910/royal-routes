      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[#001934]">Edit Event</h1>
              <p className="text-gray-600 mt-1">Update event information and settings</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <div className="flex items-center gap-2">
              <input
                ...
                className="rounded"
              />
              <Label htmlFor="is_active" className="text-sm font-semibold text-[#001934]">Published</Label>
            </div>
          </div>
